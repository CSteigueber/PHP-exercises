...
function new_exercise($x) {         //function argument $x was added
...
$monday = $week[0];         //array starts at $week[0]
...
$str = "Debugged ! Also very fun";          //changed to "..."
...
foreach($week as &$day) {           // use & to use pointer 
